...
<footer id="footer" class="border-0" style="background: var(--cnvs-contrast-0);">
            ...
            <div class="row col-mb-50">
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="widget">
                        ...
                        <p>"The Spirit Within Me, Greets and Honors, The Spirit Within You"</p>
    ...
    <!-- Copyrights
    ============================================= -->
    <div id="copyrights" style="background: url('/build/img/hero/footer.svg') no-repeat top center; background-size: cover; padding-top: 70px;">
        <div class="container">
